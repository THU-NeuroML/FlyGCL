...
if __name__ == "__main__":
    dataset_root = os.environ.get("LEROBOT_DATASET_ROOT", "./data/real_world")
    VIDEO_DIR = os.path.join(
        dataset_root,
        "videos/chunk-000/observation.images.right_third_person_camera_top_right",
    )
    JSONL_PATH = os.path.join(dataset_root, "meta/episodes.jsonl")
    OUTPUT_DIR = os.environ.get("FIRST_FRAME_OUTPUT_DIR", "./outputs/real_world_first_frames")
