...
exec bash "${REPO_ROOT}/bash/dit_dec_run_seed.sh" \
  ...
  --checkpoint-root="${CHECKPOINT_ROOT:-./outputs/dit_dec/libero_spatial}" \
  --source-checkpoint-root="${SOURCE_CHECKPOINT_ROOT:-${CHECKPOINT_ROOT:-./outputs/dit_dec/libero_spatial}}" \
