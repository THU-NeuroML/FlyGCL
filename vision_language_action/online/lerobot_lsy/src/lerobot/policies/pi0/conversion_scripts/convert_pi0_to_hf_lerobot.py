...
```python
python -m lerobot.policies.pi0.conversion_scripts.convert_pi0_to_hf_lerobot \
    --checkpoint_dir ./.cache/openpi/openpi-assets/checkpoints/pi0_aloha_sim/params \
    --output_path ./.cache/openpi/openpi-assets/checkpoints/pi0_aloha_sim_pytorch
```
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint_dir",
        default="./.cache/openpi/openpi-assets/checkpoints/pi0_aloha_sim/params",
        type=str,
