...
# bash scripts/run_baselines_flyadapter.sh [GPU_ID] [SEEDS] [DATASET] [EXTRA_NOTE]
# --------------------------------------------------------------
...
echo "========================================="
echo "Starting FlyAdapter Baseline Experiment"
...
run_experiment "flyadapter" "$BACKBONE_TO_USE" "adam" 0.005 "${FILTERED_ARGS[@]}"

echo "========================================="
echo "FlyAdapter experiment completed!"
